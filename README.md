...
## Generate text
 ...
 In version 0.0.2, you also have another option: using front matter information while running the command by using "Generate Text (use Metadata)." let's take as an example the following document.
