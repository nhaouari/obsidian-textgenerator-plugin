...
export const TemplateModalView = ({ p, labels, onSubmit, metadata }) => {
  ...
  return (
    <form className="" onSubmit={handleSubmit}>
      ...
      {labels.map((label, index) => (
        <div key={label} className="mb-6">
          <div className="flex flex-col">
            <label className="font-bold mb-2 text-gray-700">{label}</label>
            <textarea
      ...
      <button type="submit" className="bg-blue-500 px-6 py-2 rounded font-semibold hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-50">
        Generate
      </button>
    </form>
  );
